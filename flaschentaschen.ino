...
// WiFi properties
#define PORT              1337
#define NETWORK_SSID      "hacker:space:public"
#define NETWORK_PASSWORD  "przyjmujemy_datki_x86"
  ...
  public:
    ...
    void display(Adafruit_NeoPixel *strip) {
      ...
      for (int i = 0; i < screen.x * screen.y; ++i) {
        ...
        strip->setPixelColor(i, screen.pixels[i].r, screen.pixels[i].g, screen.pixels[i].b);
        strip->show();
      }
    }
};
